...
static void test_eval_native(void)
{
    ...
    CU_ASSERT(-1 != eval_env_add_var(env, "a", val_mk_number(1)));
    CU_ASSERT(-1 != eval_env_add_var(env, "b", val_mk_number(1)));
    CU_ASSERT(-1 != eval_env_add_var(env, "one", val_mk_native((intptr_t)test_native_one)));
...
static void test_eval_string(void)
{
    ...
    CU_ASSERT(-1 != eval_env_add_var(env, "a", val_mk_undefined()));
    CU_ASSERT(-1 != eval_env_add_var(env, "b", val_mk_static_string((intptr_t) "world")));
    CU_ASSERT(-1 != eval_env_add_var(env, "c", val_mk_undefined()));

    CU_ASSERT(0 == eval_string(interp, env, "\"hello\"", &res) && val_is_string(res));
    CU_ASSERT(0 == eval_string(interp, env, "a = \"hello\"", &res) && val_is_string(res));
    CU_ASSERT(-1 != eval_env_get_var(env, "a", &p) && val_is_string(p));
    CU_ASSERT(-1 != eval_env_get_var(env, "b", &p) && val_is_string(p));

    CU_ASSERT(0 == eval_string(interp, env, "a == \"hello\"", &res) && val_is_boolean(res) && val_is_true(res));
    CU_ASSERT(0 == eval_string(interp, env, "a >= \"hello\"", &res) && val_is_boolean(res) && val_is_true(res));
    CU_ASSERT(0 == eval_string(interp, env, "b == \"world\"", &res) && val_is_boolean(res) && val_is_true(res));
    CU_ASSERT(0 == eval_string(interp, env, "b >= \"world\"", &res) && val_is_boolean(res) && val_is_true(res));

    CU_ASSERT(0 == eval_string(interp, env, "a < b", &res) && val_is_boolean(res) && val_is_true(res));
    CU_ASSERT(0 == eval_string(interp, env, "b > a", &res) && val_is_boolean(res) && val_is_true(res));

    CU_ASSERT(0 == eval_string(interp, env, "c = a + ' ' + b", &res) && val_is_string(res));
    CU_ASSERT(0 == eval_string(interp, env, "c == 'hello world'", &res) && val_is_true(res));
