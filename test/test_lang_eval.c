...
static void test_eval_symbal(void)
{
    ...
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "var a = 5, b = 2", &res) && val_is_undefined(res));
    ...
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "a == 1", &res) && val_is_boolean(res) && val_is_true(res));
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "b == 1", &res) && val_is_boolean(res) && val_is_true(res));
...
static void test_eval_var(void)
{
    ...
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "c == 3", &res) && val_is_boolean(res) && val_is_true(res));
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "d == 3", &res) && val_is_boolean(res) && val_is_true(res));
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "e == 8", &res) && val_is_boolean(res) && val_is_true(res));
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "f;", &res) && val_is_undefined(res));

    // redefine f
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "var f, g, h, k = 0, j, s, m;", &res) && val_is_undefined(res));
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "f;", &res) && val_is_undefined(res));
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "g;", &res) && val_is_undefined(res));
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "h;", &res) && val_is_undefined(res));
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "k;", &res) && val_is_number(res) && 0 == val_2_double(res));
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "j;", &res) && val_is_undefined(res));
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "s;", &res) && val_is_undefined(res));
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "m;", &res) && val_is_undefined(res));
    /*
    */
...
static void test_eval_if(void)
{
    ...
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "var a = 0, b = 1, c = 1, d = 0;", &res) && val_is_undefined(res));
    ...
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "b == 1", &res) && val_is_boolean(res) && val_is_true(res));
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "c == 9", &res) && val_is_boolean(res) && val_is_true(res));

    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "if (a == 0) b = 9 else c = 2", &res) && val_is_undefined(res));
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "b == 9", &res) && val_is_boolean(res) && val_is_true(res));
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "c == 9", &res) && val_is_boolean(res) && val_is_true(res));
    ...
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "b == 9", &res) && val_is_boolean(res) && val_is_true(res));
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "c == 9", &res) && val_is_boolean(res) && val_is_true(res));
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "d == 9", &res) && val_is_boolean(res) && val_is_true(res));

    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "if (a == 0) if (b != c) d = 9 else a = 9", &res) && val_is_undefined(res));
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "a == 9", &res) && val_is_boolean(res) && val_is_true(res));
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "b == 9", &res) && val_is_boolean(res) && val_is_true(res));
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "c == 9", &res) && val_is_boolean(res) && val_is_true(res));
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "d == 9", &res) && val_is_boolean(res) && val_is_true(res));
    ...
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "a == 9", &res) && val_is_boolean(res) && val_is_true(res));
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "b == 1", &res) && val_is_boolean(res) && val_is_true(res));
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "c == 1", &res) && val_is_boolean(res) && val_is_true(res));
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "d == 9", &res) && val_is_boolean(res) && val_is_true(res));
...
static void test_eval_while(void)
{
    ...
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "var a = 0, b = 9;", &res) && val_is_undefined(res));
    ...
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "b == 0", &res) && val_is_boolean(res) && val_is_true(res));

    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "while (b < 10) {b = b + 1 a = a + 1}", &res) && val_is_undefined(res));
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "a == 10 && b == 10", &res) && val_is_boolean(res) && val_is_true(res));

    // nest
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "var c = 0; a = 9;", &res) && val_is_number(res) && 9 == val_2_integer(res));
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "while (a) {a=a-1; b=9; while(b){b=b-1;c=c+1;}}", &res) && val_is_undefined(res));
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "c == 81", &res) && val_is_boolean(res) && val_is_true(res));

    // continue
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "a = 0, b = 0;", &res) && val_is_number(res) && 0 == val_2_integer(res));
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "while (b < 10) {b = b + 1; if (b == 5) continue; a = a + 1}", &res) && val_is_undefined(res));
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "a == 9 && b == 10", &res) && val_is_boolean(res) && val_is_true(res));
    ...
    // compose
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "a = 9, b = 9, c = 0;", &res) && val_is_number(res) && 0 == val_2_integer(res));
    ...
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "a == 4", &res) && val_is_boolean(res) && val_is_true(res));
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "b == 2", &res) && val_is_boolean(res) && val_is_true(res));
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "c == 3", &res) && val_is_boolean(res) && val_is_true(res));
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "a == 4 && b == 2 && c == 3", &res) && val_is_boolean(res) && val_is_true(res));
...
*/
    ...
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "var a = 1, b = 0;", &res) && val_is_undefined(res));
    ...
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "b == 3", &res) && val_is_boolean(res) && val_is_true(res));

    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "def fn(a, b) return a + b", &res) && val_is_function(res));
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "fn", &res) && val_is_function(res));
    ...
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "a == 4 && b == 4", &res) && val_is_boolean(res) && val_is_true(res));
...
static void test_eval_native(void)
{
    ...
    CU_ASSERT(0 <= eval_env_add_native(env, "one", test_native_one));
    CU_ASSERT(0 <= eval_env_add_native(env, "add", test_native_add));
    CU_ASSERT(0 <= eval_env_add_native(env, "fib", test_native_fib));

    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "var a = 1, b = 1;", &res));
    ...
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "a == 1000", &res) && val_is_boolean(res) && val_is_true(res));
...
static void test_eval_string(void)
{
    ...
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "var a, b = 'world', c;", &res) && val_is_undefined(res));
    ...
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "c.length()", &res) && val_is_number(res) && 11 == val_2_double(res));
    ...
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "a[0].length()", &res) && val_is_number(res) && 1 == val_2_integer(res));

    eval_env_deinit(env);
}

static void test_eval_gc(void)
{
    eval_env_t env_st, *env = &env_st;
    val_t *res;
    ...
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "var a = 0, b = 'world', c = 'hello';", &res) && val_is_undefined(res));
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "var d = c + ' ', e = b + '.', f;", &res) && val_is_undefined(res));
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "def add(a, b) {var n = 10; while(n) {n = n-1; a+b}return a + b}", &res) && val_is_function(res));
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "while (a < 1000) { f = add(d, e); a = a + 1}", &res) && val_is_undefined(res));
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "a == 1000", &res) && val_is_true(res));
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "d", &res) && val_is_string(res));
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "e", &res) && val_is_string(res));
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "f", &res) && val_is_string(res));
    CU_ASSERT(0 == eval_string(env, eval_buf, EVAL_BUF_SIZE, "f == 'hello world.'", &res) && val_is_boolean(res) && val_is_true(res));
...
CU_pSuite test_lang_eval_entry()
{
    ...
    if (suite) {
        ...
        CU_add_test(suite, "eval gc",           test_eval_gc);
        if (0) {
        }
    }
